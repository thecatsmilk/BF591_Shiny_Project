...
ui <- fluidPage(
  ...
  # title
  titlePanel('BF591—Final Project; Dan Carvalho (Spring 2023)'),
  
  # disclaimer about app and data needed to run
  tags$h4('Disclaimer'),
  HTML('<p>To use this application, please download the relevant data from <a href = "https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE64810">here</a>.</p>'),
